# 0.7.1 (Sep 01, 2026)
* Removed the `ensure_role_password` data source added in 0.7.0: it altered the role's password during plan/refresh, changing infrastructure when terraform reported "No changes".
